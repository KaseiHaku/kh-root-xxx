...
@Slf4j
@Service
public class FeatureWriteSvcImpl extends AbstractBaseWriteSvc<FeatureDto, FeaturePo, FeatureQry, FeatureDao> implements FeatureWriteSvc {

    public FeatureWriteSvcImpl(FeatureDao baseDao, MapperFactory mapperFactory,
                               BaseReadSvc<FeatureDto, FeatureQry> baseReadSvc) {
